...
class Player {
 public:
  ...
  virtual bool make_trump(int round, Suit &order_up_suit) const = 0;

  //REQUIRES Player has at least one card
  //EFFECTS  Player adds one card to hand and removes one card from hand.
  virtual Card add_and_discard(Card card_to_add, Suit upcard) = 0;
  ...
  //REQUIRES Player has at least one card
  //EFFECTS  Removs one card at random from the hand.
  //  The card is removed from the player's hand.
  virtual Card remove_card() = 0;
